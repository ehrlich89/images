...
The NearYou app shows you a reference application, where you can see the messages that are currently being received by the app or check whether you have correctly configured the campaign actions. 
